...
${extractionResult.titulo || 'Vaga Disponível'}

${extractionResult.empresa ? `🏢 EMPRESA: ${extractionResult.empresa}` : ''}

${extractionResult.localidade ? `📍 LOCALIDADE: ${extractionResult.localidade}` : ''}

${extractionResult.descricao ? `📝 DESCRIÇÃO:\n${extractionResult.descricao}` : ''}

${extractionResult.requisitos ? `✅ REQUISITOS:\n${extractionResult.requisitos}` : ''}

${extractionResult.beneficios ? `💰 BENEFÍCIOS:\n${extractionResult.beneficios}` : ''}

${extractionResult.salario ? `💵 SALÁRIO: ${extractionResult.salario}` : ''}

${extractionResult.horario ? `⏰ HORÁRIO: ${extractionResult.horario}` : ''}

${extractionResult.tipo_contrato ? `📄 CONTRATO: ${extractionResult.tipo_contrato}` : ''}

${extractionResult.informacoes_adicionais ? `ℹ️ INFO ADICIONAL:\n${extractionResult.informacoes_adicionais}` : ''}

${extractionResult.forma_candidatura ? `📲 CANDIDATURA:\n${extractionResult.forma_candidatura}` : ''}
