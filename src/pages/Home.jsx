...
import { Search, Briefcase, MessageCircle, Newspaper, Crown, ArrowRight } from "lucide-react";
...
export default function Home() {
  return (
    <div className="min-h-screen bg-slate-50">
      <div className="bg-gradient-to-br from-blue-600 to-blue-800 pt-12 pb-20 px-4">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <Link to={createPageUrl('Jobs')}>
            <Button className="h-14 px-8 text-lg bg-white text-blue-600 hover:bg-white/90 rounded-xl">
