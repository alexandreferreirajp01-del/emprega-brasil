...
const vagasSubmenuItems = [
  ...
  { id: 'post-manual', name: 'POST MANUAL', icon: PlusCircle, color: 'emerald', page: 'PostManual', description: 'Publicar vagas manualmente, sem integrações externas', roles: ['admin', 'dono'] },
