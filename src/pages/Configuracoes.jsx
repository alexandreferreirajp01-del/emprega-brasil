...
const menuItems = [
  ...
  { id: 'conversor-padrao', name: 'Conversor Padrão de Vagas', icon: Sparkles, color: 'pink', page: 'ConversorPadraoVagas', description: 'Padronize vagas com layout fixo e profissional', permissionId: 'conversor_padrao_vagas' },
