...
const menuItems = [
  ...
  { id: 'comunidade', name: 'Gerenciar Comunidade', icon: MessageSquare, color: 'pink', page: 'GerenciarComunidade', description: 'Posts, comentários e chat', permissionId: 'gerenciar_comunidade' },
  { id: 'solicitacoes', name: 'Solicitações', icon: ClipboardList, color: 'amber', page: 'GerenciarSolicitacoes', description: 'Aprovar conteúdos de recrutadores', permissionId: 'solicitacoes' },
