...
const menuItems = [
  ...
  { id: 'vagas-converter', name: 'Vagas Converter', icon: Sparkles, color: 'pink', page: 'VagasConverter', description: 'Converter imagens em posts profissionais', permissionId: 'vagas_converter' },
