      ...
      <div className="max-w-5xl mx-auto px-4 -mt-6">
                      ...
                      <div className="flex items-start gap-3">
                       <div className={`w-9 h-9 rounded-xl flex items-center justify-center flex-shrink-0 ${colors.bg}`}>
                        ...
                        <div className="flex-1 min-w-0">
                          <div className="flex items-start justify-between gap-2 mb-1">
                            <div className="flex items-center gap-2 flex-wrap min-w-0">
                              ...
                              {isEnabled
                                ...
                                : <Badge className="bg-red-100 text-red-700 text-xs flex items-center gap-1 whitespace-nowrap"><XCircle className="w-3 h-3" />Off</Badge>
                              }
                            </div>
                            <Switch
                              checked={isEnabled}
                          ...
                          <p className="text-xs text-slate-500 dark:text-slate-400 mb-2 leading-relaxed">{fn.description}</p>
                          <div className="flex flex-wrap gap-1.5">
                            ...
                            <Badge variant="outline" className="text-xs text-slate-500 max-w-full">
                              ⚡ <span className="truncate">{fn.trigger}</span>
                            </Badge>
        ...
        <div className="fixed bottom-20 md:bottom-6 right-4 md:right-6 z-50">
          <Button
            onClick={handleSave}
            disabled={saving}
            className="bg-blue-700 hover:bg-blue-800 shadow-xl rounded-xl px-4 h-10 text-sm font-semibold"
          >
