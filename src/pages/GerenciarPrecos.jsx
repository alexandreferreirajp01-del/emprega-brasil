    ...
    <div className="min-h-screen bg-slate-50 pb-20">
      ...
      <div className="max-w-6xl mx-auto px-4 py-6 space-y-4">
        ...
        <Card className="rounded-2xl overflow-hidden border-2 border-orange-300 shadow-lg">
          ...
          {!promoConfig?.is_enabled && (
            <CardContent className="p-3 bg-orange-50 text-center">
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="flex items-start justify-between gap-4 mb-2">
                        ...
                        <div className="flex items-center gap-2 flex-shrink-0">
                          <Button size="sm" variant="outline" onClick={() => handleEdit(plan)} className="rounded-lg">
                            <Edit className="w-4 h-4" />
                          </Button>
                          <Button size="sm" variant="outline" onClick={() => handleDelete(plan)} className="rounded-lg text-red-600 hover:bg-red-50">
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mt-4">
                        <div>
                          ...
                          <p className="text-xl font-bold text-green-600">R$ {(plan.price || 0).toFixed(2)}</p>
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <Button
                ...
                className="w-full h-16 rounded-xl text-white font-semibold"
                style={{
