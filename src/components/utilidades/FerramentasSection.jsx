...
import PreparacaoIA from "./ferramentas/PreparacaoIA";
import TestePerfilDISC from "./ferramentas/TestePerfilDISC";
...
const FERRAMENTAS = [
  ...
  { id: 'perfil', nome: 'Teste Comportamental', desc: 'Descubra seu perfil DISC', icon: UserCheck, cor: 'bg-indigo-500' }
];

export default function FerramentasSection({ user }) {
  ...
  const renderFerramenta = () => {
    switch (ferramentaAtiva) {
      ...
      case 'preparacao': return <PreparacaoIA user={user} />;
      case 'perfil': return <TestePerfilDISC user={user} />;
      default: return null;
    }
  };
