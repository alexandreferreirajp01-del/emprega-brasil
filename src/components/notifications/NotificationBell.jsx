    ...
    <Popover open={open} onOpenChange={setOpen}>
      <PopoverTrigger asChild>
        ...
        >
          ...
          {unreadCount > 0 && (
            <span className="absolute top-0 right-0 min-w-5 h-5 px-1 bg-red-500 dark:bg-red-600 text-white text-[10px] font-bold rounded-full flex items-center justify-center leading-none border-2 border-white dark:border-slate-800">
